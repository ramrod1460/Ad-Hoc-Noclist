...
public class NoclistAPICalls {
	...
	public Optional<String> getAuthToken() throws InterruptedException {
        ...
        //we provide a Supplier written as a java 8 lambda to the retry method.
		//in case of any error our supplier return an empty optional which indicates that another try is required
